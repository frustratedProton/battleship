					...
					{store.connecting ? (
						<div className="flex flex-col items-center justify-center py-10">
							...
							<div className="relative flex items-center justify-center mb-4">
								...
								<div className="absolute w-12 h-12 bg-blue-400 rounded-full opacity-75 animate-ping"></div>
								{/* The stationary circle */}
								<div className="relative z-10 bg-blue-500 rounded-full p-3 shadow-lg shadow-blue-500/30">
									<svg
